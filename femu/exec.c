                            ...
                            Error **errp)
{
    ...
    if (mem_prealloc) {
        printf("Coperd,%s,doing prealloc now! will call os_mem_prealloc\n", __func__);
...
#if 0
    printf("Coperd,%s,new RAMBlock host:%p,lenth:%ld,mr:%s\n", __func__,
            new_block->host, new_block->max_length,
            memory_region_name(new_block->mr));
#endif
                                   ...
                                   Error **errp)
{
    ...
    printf("Coperd,%s,new_block->host=%p,file_ram_alloc,mem_path=%s,size=%ld\n",
            __func__, new_block->host, mem_path, size);
