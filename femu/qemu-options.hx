...
DEF("socvm", 0, QEMU_OPTION_socvm,
    "-socvm Emulate SoCVM or not\n",
    QEMU_ARCH_ALL)
STEXI
@item -socvm
@findex -socvm
...
DEF("dmabuf", 0, QEMU_OPTION_dmabuf,
    "-dmabuf Enable exposing host hugepage based dmabuf for SoCVM-server\n",
    QEMU_ARCH_ALL)
STEXI
@item -dmabuf
@findex -dmabuf
