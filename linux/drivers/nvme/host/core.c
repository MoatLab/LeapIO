...
struct leap_qpbuf qpbuf[MAX_QPBUF]; /* Coperd: TODO */
EXPORT_SYMBOL_GPL(qpbuf);
...
static void __nvme_revalidate_disk(struct gendisk *disk, struct nvme_id_ns *id)
{
    ...
    qpbuf[0].lba_shift = ns->lba_shift;
    printk("Coperd,%s,lba_shift=%d\n", __func__, ns->lba_shift);
...
int nvme_init_identify(struct nvme_ctrl *ctrl)
{
    ...
    qpbuf[0].mdts = id->mdts;
    printk("Coperd,%s,mdts=%d\n", __func__, id->mdts);
