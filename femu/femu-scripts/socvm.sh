...
OSIMGF=$IMGDIR/socvm.qcow2
# virtual NVMe disk image
NVMEIMGF=$IMGDIR/vssd2.raw
...
sudo x86_64-softmmu/qemu-system-x86_64 \
    ...
    -device nvme,drive=id0,serial=serial0,leap_qp_mapping=0,id=nvme0 \
    -net user,hostfwd=tcp::8081-:22 \
    -net nic,model=virtio \
    -object memory-backend-file,size=16M,share,mem-path=/dev/shm/ivshmem,id=hostmem \
