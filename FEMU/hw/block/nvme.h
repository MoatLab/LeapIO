...
enum NvmeAdminCommands {
    ...
    NVME_ADM_CMD_GPA_MAP        = 0xf9,
    NVME_ADM_CMD_GPA_UNMAP      = 0xfa,
    NVME_ADM_CMD_WPT_MAP        = 0xfd,
    NVME_ADM_CMD_WPT_UNMAP      = 0xfe,
};
...
enum NvmeIoCommands {
    ...
    NVME_CMD_DSM                = 0x09,
    NVME_SNAPSHOT_READ          = 0x0a,
    NVME_SNAPSHOT_WRITE         = 0x0b,
};
...
struct wpt_qp_data {
    uint64_t q_baddr[16]; /* Coperd: 64KB SQ -> 1024 entries */
    int q_entry_sz;
    int q_nr_entry;
    int q_id;
    int q_type;
...
struct leap_qpbuf {
    int         nvqs;
    struct wpt_qp_data sdbdata;
    struct wpt_qp_data *sqdata;
    struct wpt_qp_data *cqdata;
    uint64_t    *sq_baddr; /* Coperd: SQ base addrs */
    uint64_t    *cq_baddr; /* Coperd: CQ base addrs */
    int         *sqsz;
    int         *cqsz;
    uint64_t    dbs_addr; /* Coperd: Shadow DB addr */
    uint64_t    eis_addr; /* Coperd: Eventidx addr */
    bool        *sq_mapped;
    bool        *cq_mapped;
    bool        db_mapped;
};
...
typedef struct NvmeCtrl {
    ...
    uint8_t         leap_qp_mapping;
    bool            ioq_isr_enabled;
    bool            ioq_processing_enabled;
} NvmeCtrl;
